...
pub mod renewable {
    pub mod sql_types {
        ...
        #[diesel(postgres_type(name = "aggregation_kind", schema = "renewable"))]
    ...
    diesel::table! {
        renewable.ts_metadata (ingestion_id) {
            ingestion_id -> Int8,
    ...
    diesel::table! {
        renewable.ts_store (ingestion_id, datetime) {
            ingestion_id -> Int8,
